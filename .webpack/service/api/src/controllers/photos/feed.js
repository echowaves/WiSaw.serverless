...
exports.byDate = exports.main = undefined;
...
var main = exports.main = function () {
  var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(event, context, callback) {
    var data, location, _response, limit, offset, lat, lng, point, photos, _response2, response;
...
var byDate = exports.byDate = function () {
  var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(event, context, callback) {
    var data, location, daysAgo, timeZoneShiftHours, _response3, limit, offset, lat, lng, point, photos, _createdAt, utcDate, currentDate, _response4, response;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            location = data ? data.location : null;
            daysAgo = data ? data.daysAgo || 0 : 0;
            timeZoneShiftHours = data ? data.timeZoneShiftHours || 0 : 0; // defaults to UTC
          ...
          case 14:
            ...
            photos = void 0;
            _context2.prev = 22;
            utcDate = (0, _moment2.default)().startOf('day');
            currentDate = (0, _moment2.default)().startOf('day').add(timeZoneShiftHours, 'hours');
            ...
            return _photo2.default.findAll({
              where: {
                createdAt: (_createdAt = {}, (0, _defineProperty3.default)(_createdAt, Op.gte, currentDate.clone().subtract(daysAgo, 'days')), (0, _defineProperty3.default)(_createdAt, Op.lte, currentDate.clone().add(1, 'days').subtract(daysAgo, 'days')), _createdAt)
                // active: true,
              },
              attributes: {
                include: [[_sequelize2.default.fn('ST_Distance', point, _sequelize2.default.col('location')), 'distance']]
          ...
          case 34:
            ...
            console.log('Unable to retrieve Photos feed', _context2.t0);
            _response4 = {
              statusCode: 500,
              body: (0, _stringify2.default)({ error: 'Unable to retrieve Photos feed' })
            };

            callback(null, _response4);
            return _context2.abrupt('return', false);
  ...
  return function byDate(_x4, _x5, _x6) {
