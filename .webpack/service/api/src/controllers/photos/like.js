      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 4;
            _context.next = 7;
            return _photo2.default.update({ likes: _sequelize2.default.literal('likes + 1') }, { where: { id: id } });
          ...
          case 14:
            ...
            console.log('Unable to like a Photo', _context.t0);
            _response2 = {
              statusCode: 500,
              body: (0, _stringify2.default)({ error: 'Unable to activate a Photo' })
            };

            callback(_context.t0, _response2);
            return _context.abrupt('return');
